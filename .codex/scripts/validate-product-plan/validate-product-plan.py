...
def generate_json_report(foundation_results: Dict[str, Tuple[bool, str]], 
                        development_results: Dict[str, Tuple[bool, str]]) -> Dict:
    ...
    return {
        ...
        "summary": {
            "foundation_passed": sum(1 for success, _ in foundation_results.values() if success),
            "foundation_total": len(foundation_results),
            "development_passed": sum(1 for success, _ in development_results.values() if success),
            "development_total": len(development_results),
            "overall_success": all(success for success, _ in {**foundation_results, **development_results}.values())
        }
    }
