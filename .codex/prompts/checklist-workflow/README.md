...
- Scratchpads: use `scratchpaper/` (plans under `scratchpaper/initiatives/$INITIATIVE_NAME/plans/optimized/`; checklists under `scratchpaper/initiatives/$INITIATIVE_NAME/checklists/raw/<YYYY-MM-DD>-<name>-checklist.md`); promote or clean up as you go.
...
2. `plan-to-checklist` - load the plan from `scratchpaper/initiatives/$INITIATIVE_NAME/plans/optimized/` and turn it into a checklist under `scratchpaper/initiatives/$INITIATIVE_NAME/checklists/raw/`.
...
### Command variables
- `create-initiative-plan`: `$INITIATIVE_NAME` (load the optimized prompt from `scratchpaper/initiatives/$INITIATIVE_NAME/prompts/optimized/*.md`, write the raw plan to `scratchpaper/initiatives/$INITIATIVE_NAME/plans/raw/`).
- `plan-to-checklist`: `$INITIATIVE_NAME` (load the optimized plan from `scratchpaper/initiatives/$INITIATIVE_NAME/plans/optimized/*.md`, write the raw checklist to `scratchpaper/initiatives/$INITIATIVE_NAME/checklists/raw/`).
...
### Command cheatsheet
- `create-initiative-plan`: Start or reorient an initiative. Outputs goals, constraints, branch suggestion, and initial plan (driven by the contents of the file at `scratchpaper/initiatives/$INITIATIVE_NAME/prompts/optimized/*.md`).
- `plan-to-checklist`: Convert the plan from `scratchpaper/initiatives/$INITIATIVE_NAME/plans/optimized/<plan-file>.md` into the markdown checklist (major tasks and subtasks) under `scratchpaper/initiatives/$INITIATIVE_NAME/checklists/raw/<YYYY-MM-DD>-<name>-checklist.md`.
...
### Checklist artifacts
- Location: `scratchpaper/initiatives/$INITIATIVE_NAME/checklists/raw/<YYYY-MM-DD>-<project-or-feature-name>-checklist.md`.
- Structure:
...
- Link to supporting scripts under `.codex/scripts/` when relevant; keep checklist and code in sync.
